...
import com.sipc.clockin.pojo.domain.enumeration.ResultEnum;
...
public class CommonResult<T> implements Serializable {
    ...
    public static <T> CommonResult<T> permissionDenied() {
        return new CommonResult<>(ResultEnum.PERMISSION_DENIED.getCode(), ResultEnum.PERMISSION_DENIED.getMessage(), null);
    }
